...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=str,
        default='teacher',
        help = 'Is it teacher model or Student'
    )
    parser.add_argument(
        "--task_name",
        type=str,
...
def main():
    ...
    model_name_or_path = 'microsoft/deberta-v3-base' if args.info=='teacher' else 'microsoft/deberta-v3-xsmall'
    ...
    if args.checkpoint_path:
        ...
        logger.info(f"You are learning filters for checkpoint in {model_name_or_path}. "
                    f"Please make sure it is properly initialized on the target task.")
        model = model_class.from_pretrained(
            model_name_or_path,
